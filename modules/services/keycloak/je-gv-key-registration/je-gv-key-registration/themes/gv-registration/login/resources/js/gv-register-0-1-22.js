(function() {
    ...
    function bootstrapPreview() {
        ...
        if (document.getElementById("kc-register-form")) {
            ...
            usernameInput.style = "color:var(--pf-v5-c-form__label--m-disabled--Color);font-weight:bold;font-style:italic;";
        }

        if (!familyInput || !givenInput) return;

        // const container = document.createElement("div");
        // container.className = "je-gv-key-username-preview";
        // container.innerHTML = [
        //     '<div class="je-gv-key-username-preview__label">GV account identifier</div>',
        //     '<div class="je-gv-key-username-preview__value" id="je-gv-key-username-preview-value">—</div>',
        //     '<p class="je-gv-key-username-preview__help">',
        //     'Generated from ',
        ...
        // const previewValue = container.querySelector("#je-gv-key-username-preview-value");
        const update = function() {
            ...
            const suggestedUsername = family || given ? family + given + "2@gv.je" : ""; // @gv.je" : "@gv.je";

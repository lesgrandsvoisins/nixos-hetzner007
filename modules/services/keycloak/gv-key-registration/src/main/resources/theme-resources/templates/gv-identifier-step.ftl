        ...
        <form id="kc-gv-identifier-form" action="${url.loginAction}" method="post">
            <div class="info-message" style="background-color: #e8f0fe; padding: 12px; border-radius: 6px; margin-bottom: 20px;">
                <p style="margin: 0; font-size: 14px;">
                    <strong>ℹ️ ${msg("gvIdentifierRule")}</strong><br/>
                    ${msg("gvIdentifierRuleDescription", (gvIdentifierRule!'family[:4] + given[:4] + counter'))}
                </p>
            </div>
            ...
            (function() {
                ...
                function updatePreview() {
                    ...
                    if (firstName && lastName) {
                        ...
                        if (!previewDiv) {
                            const form = document.getElementById('kc-gv-identifier-form');
